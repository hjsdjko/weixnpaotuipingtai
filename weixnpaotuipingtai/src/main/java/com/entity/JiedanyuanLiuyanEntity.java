...
public class JiedanyuanLiuyanEntity<T> implements Serializable {
    private static final long serialVersionUID = 1L;


	public JiedanyuanLiuyanEntity() {

	}

	public JiedanyuanLiuyanEntity(T t) {
		try {
     ...
     * 评论内容
     */
    @TableField(value = "jiedanyuan_liuyan_text")
    ...
    public String toString() {
        return "JiedanyuanLiuyan{" +
            "id=" + id +
            ", jiedanyuanId=" + jiedanyuanId +
            ", yonghuId=" + yonghuId +
            ", jiedanyuanLiuyanText=" + jiedanyuanLiuyanText +
