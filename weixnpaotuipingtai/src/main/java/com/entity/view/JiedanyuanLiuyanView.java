...
public class JiedanyuanLiuyanView extends JiedanyuanLiuyanEntity implements Serializable {
	...
	public JiedanyuanLiuyanView() {

	}

	public JiedanyuanLiuyanView(JiedanyuanLiuyanEntity jiedanyuanLiuyanEntity) {
		try {
			BeanUtils.copyProperties(this, jiedanyuanLiuyanEntity);
