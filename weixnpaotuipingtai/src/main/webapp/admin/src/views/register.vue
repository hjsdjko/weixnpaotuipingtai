<template>
    <div style="backgroundImage: url('/weixnpaotuipingtai/img/back-img-bg.jpg');background-size:cover;">
        <div class="container">
            <div class="login-form" style="backgroundColor:rgba(183, 174, 174, 0.5);borderRadius:22px">
                <h1 class="h1" style="color:#000;fontSize:28px;">微信小程序跑腿平台注册</h1>
                <el-form class="rgs-form" label-width="120px">
                        ...
                        <el-form-item label="跑腿员姓名" class="input" v-if="tableName=='jiedanyuan'">
                            <el-input v-model="ruleForm.jiedanyuanName" autocomplete="off" placeholder="跑腿员姓名"  />
                        </el-form-item>
