    ...
    <view class="content">
        <form class="app-update-pv">
            ...
            <view
                    ...
                    class="cu-form-group">
                <view :style='{"width":"160rpx","fontSize":"28rpx","color":"#008761","textAlign":"left"}'
                      class="title">跑腿员姓名</view>
                <input   disabled
                         :style='{"boxShadow":"0 0 0px rgba(0,0,0,.6) inset","backgroundColor":"rgba(255, 255, 255, 1)","borderColor":"#008761","borderRadius":"0px","color":"#008761","textAlign":"left","borderWidth":"0 0 6rpx","fontSize":"24rpx","borderStyle":"solid","height":"88rpx","marginTop":"7rpx"}'
                         :disabled="ro.jiedanyuanName" type="text" v-model="ruleForm.jiedanyuanName" placeholder="跑腿员姓名"></input>
            </view>
                <view
                        ...
                        class="cu-form-group" @tap="jiedanyuanPhotoTap">
                    <view :style='{"width":"160rpx","fontSize":"28rpx","color":"#008761","textAlign":"left"}'
                          class="title">头像</view>
                    <view class="right-input" style="padding:0;textAlign:left">
                        <image
                                ...
                                class="avator" v-if="ruleForm.jiedanyuanPhoto" :src="ruleForm.jiedanyuanPhoto" mode="aspectFill">
                        </image>
            ...
            <view
                ...
                <input   disabled
                         :style='{"boxShadow":"0 0 0px rgba(0,0,0,.6) inset","backgroundColor":"rgba(255, 255, 255, 1)","borderColor":"#008761","borderRadius":"0px","color":"#008761","textAlign":"left","borderWidth":"0 0 6rpx","fontSize":"24rpx","borderStyle":"solid","height":"88rpx","marginTop":"7rpx"}'
                         :disabled="ro.jiedanyuanPhone" type="text" v-model="ruleForm.jiedanyuanPhone" placeholder="联系方式"></input>
            </view>
            <view
                    :style='{"boxShadow":"0","backgroundColor":"rgba(255, 255, 255, 0.25)","borderColor":"rgba(228, 232, 230, 1)","margin":"0 0 0px 0","borderWidth":"2rpx","borderStyle":"none none solid none ","height":"88rpx"}'
                    class="cu-form-group">
                ...
                <input   disabled
                         :style='{"boxShadow":"0 0 0px rgba(0,0,0,.6) inset","backgroundColor":"rgba(255, 255, 255, 1)","borderColor":"#008761","borderRadius":"0px","color":"#008761","textAlign":"left","borderWidth":"0 0 6rpx","fontSize":"24rpx","borderStyle":"solid","height":"88rpx","marginTop":"7rpx"}'
                         :disabled="ro.jiedanyuanEmail" type="text" v-model="ruleForm.jiedanyuanEmail" placeholder="邮箱"></input>
            </view>
    ...
    export default {
		...
		/*下拉框*/
            ...
            if (options.id) {
                ...
                // 获取信息
                let res = await this.$api.info(`jiedanyuan`, this.ruleForm.id);
                this.ruleForm = res.data;
            }
            if(options.jiedanyuanId){
                this.ruleForm.jiedanyuanId = options.jiedanyuanId;
            }
            // 跨表
            // this.styleChange()
        },
        methods: {
			...
			jiedanyuanPhotoTap() {
                ...
                this.$api.upload(function(res) {
                    _this.ruleForm.jiedanyuanPhoto = _this.$base.url + 'upload/' + res.file;
                    _this.$forceUpdate();
                    _this.$nextTick(() => {
                        // _this.styleChange()
                    })
            ...
            async onSubmitTap() {
				...
				if ((!this.ruleForm.jiedanyuanName)) {
                    this.$utils.msg(`跑腿员姓名不能为空`);
                    return
                }
				if ((!this.ruleForm.jiedanyuanPhoto)) {
				...
				if ((!this.ruleForm.jiedanyuanPhone) && (!this.$validate.isMobile(this.ruleForm.jiedanyuanPhone))) {
                    this.$utils.msg(`联系方式不能为空并且需要输入正确格式`);
                    return
                }
				if ((!this.ruleForm.jiedanyuanEmail) && (!this.$validate.isEmail(this.ruleForm.jiedanyuanEmail))) {
                    this.$utils.msg(`邮箱不能为空并且需要输入正确格式`);
                    return
                }
                if (this.ruleForm.id) {
                    await this.$api.update(`jiedanyuan`, this.ruleForm);
                } else {
                    await this.$api.save(`jiedanyuan`, this.ruleForm);
                }
